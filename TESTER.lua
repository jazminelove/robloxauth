return function(key)
    local success, validateModule = pcall(function()
        return loadstring(game:HttpGet("https://raw.githubusercontent.com/jazminelove/robloxauth/refs/heads/main/NEWAUTHKEY.lua"))()
    end)

    if success and type(validateModule) == "function" then
        local accessGranted = validateModule(key)
